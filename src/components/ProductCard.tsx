  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-secondary">
        ...
        {badge && (
          <span
            className={`absolute top-4 left-4 px-3 py-1 text-xs font-sans font-bold tracking-wider uppercase ${
              badge === "SALE"
      ...
      {/* Product Info */}
      <div className="p-5">
        <p className="text-xs font-sans text-muted-foreground tracking-widest uppercase mb-2">
          {category}
        </p>
        <h3 className="text-lg font-serif text-foreground mb-3 tracking-wide">
          {name}
        </h3>
        <div className="flex items-center gap-3">
          ...
          {originalPrice && (
            <>
              ...
              <span className="text-xs font-sans bg-destructive text-destructive-foreground px-2 py-0.5 rounded">
                -{discount}%
              </span>
            </>
          )}
