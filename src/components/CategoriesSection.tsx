...
const CategoriesSection = () => {
  ...
  const categories = [
    {
      id: 1,
      name: t("categories.shapewear"),
      description: t("categories.shapewear.desc"),
      image: "https://images.unsplash.com/photo-1594381898411-846e7d193883?w=600&q=80",
    },
    {
      id: 2,
      name: t("categories.activewear"),
      description: t("categories.activewear.desc"),
          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end p-8 text-center">
                <h3 className="text-2xl md:text-3xl font-serif text-foreground mb-2 tracking-wide">{category.name}</h3>
                <p className="text-sm font-sans text-muted-foreground tracking-wider uppercase mb-4">{category.description}</p>
