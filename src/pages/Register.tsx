        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-foreground font-sans tracking-wide uppercase text-xs">
                Nombre Completo
              </Label>
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-foreground font-sans tracking-wide uppercase text-xs">
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                className="mt-1 border-border data-[state=checked]:bg-primary data-[state=checked]:border-primary"
              />
              <Label htmlFor="newsletter" className="text-sm text-muted-foreground font-sans leading-relaxed cursor-pointer">
            ...
            <Button
              type="submit"
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-sans tracking-widest uppercase py-6 mt-2"
            >
              Crear Cuenta
            </Button>
          </form>
